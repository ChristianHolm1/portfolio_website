...
export const codingProjectsData = [
  ...
  },
  {
    ...
    description:
      "This is a program made to track the time of employees. It's a full-stack web application made with C# and .NET, utilizing.",
    category: "Web Development, Database and MVC",
    technologies: [
      { name: "API", url: "" },
      { name: "C#", url: "https://docs.microsoft.com/en-us/dotnet/csharp/" },
      { name: ".NET", url: "https://dotnet.microsoft.com/" },
      { name: "MVC", url: "https://dotnet.microsoft.com/apps/aspnet/mvc" },
      {
        name: "MSSQL",
